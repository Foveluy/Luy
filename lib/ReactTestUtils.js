(function umd(root, factory) {
    if (typeof exports === "object" && typeof module === "object") {
        module.exports = factory(require("../release/Luy"));
        
    } else if (typeof define === "function" && define.amd) {
        define(["../release/Luy"], factory);
        
    } else if (typeof exports === "object") {
        exports["ReactTestUtils"] = factory(require("../release/Luy"));
    } else {
    ...
    var ReactTestUtils = {
        renderIntoDocument: function(element) {
            ...
            return React.default.render(element, div);
        },
